<?php
  ...
  // DBに接続
  $dsn = 'mysql:host=db;dbname=circle;charset=utf8';
  $user = 'root';
  $password = 'pass';
    ...
    <main role="main" class="container" style="padding:60px 15px 0">
      <div>
        ...
        <form action="write.php" method="post">
          ...
          <div class="form-group">
            <label>Delete password (4 digits)</label>
...
<?php while ($row = $stmt->fetch()): ?>
        <div class="card">
          <div class="card-header"><?php echo $row['title']? $row['title']: '(Untitled)'; ?></div>
          <div class="card-body">
          ...
          <div class="card-footer">
            ...
            (<?php echo $row['date'] ?>)
              ...
              <input type="text" name="pass" placeholder="Delete password" class="form-control">
